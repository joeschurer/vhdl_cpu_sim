...
HD_PWD='C:/ECE1195/Lab4/CPU/CPU.runs/CPU_0_CPU_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_0_CPU_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_0_CPU_0_0.tcl
