...
HD_PWD='C:/ECE1195/Lab4/CPU/CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_0_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_0_wrapper.tcl -notrace
