...
HD_PWD='C:/ECE1195/Lab4/CPU/CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_0_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_0_wrapper.tcl
