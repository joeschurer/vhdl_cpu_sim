...
################################################################
# This is a generated script based on design: CPU_0
#
...
# Hierarchical cell: LAB_CPU
proc create_hier_cell_LAB_CPU { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_LAB_CPU() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -from 31 -to 0 MemoryAddress
  create_bd_pin -dir I -from 31 -to 0 MemoryDataIn
  create_bd_pin -dir O -from 31 -to 0 MemoryDataOut
  ...
  connect_bd_net -net CPU_0_MemWrite [get_bd_pins CPU_0/MemWrite] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net CPU_0_MemoryAddress [get_bd_pins MemoryAddress] [get_bd_pins CPU_0/MemoryAddress]
  connect_bd_net -net CPU_0_MemoryDataOut [get_bd_pins MemoryDataOut] [get_bd_pins CPU_0/MemoryDataOut]
  connect_bd_net -net Net [get_bd_pins Reset] [get_bd_pins CPU_0/Reset]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins MemoryDataIn] [get_bd_pins CPU_0/MemoryDataIn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Clock] [get_bd_pins CPU_0/Clock]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: LAB_CPU
  create_hier_cell_LAB_CPU [current_bd_instance .] LAB_CPU
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {5} \
  ...
  # Create port connections
  connect_bd_net -net CPU_0_MemoryAddress [get_bd_pins LAB_CPU/MemoryAddress] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net CPU_0_MemoryDataOut [get_bd_pins LAB_CPU/MemoryDataOut] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net Net [get_bd_pins LAB_CPU/Reset] [get_bd_pins axi_regmap_0/REG0_IN] [get_bd_pins axi_regmap_0/REG0_OUT] [get_bd_pins blk_mem_gen_0/rstb]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins LAB_CPU/MemoryDataIn] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LAB_CPU/Clock] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_regmap_0/S_AXI_ACLK] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_regmap_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins LAB_CPU/dout1] [get_bd_pins blk_mem_gen_0/web]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins LAB_CPU/dout] [get_bd_pins blk_mem_gen_0/enb]
