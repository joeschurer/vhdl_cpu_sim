...
begin
    ...
    ctrl : mul_control port map(test=>test, clk=>clk,multiplier=>multiplier,multiplicand=>multiplicand,multiplicand_en=>multiplicand_en,multiplier_en=>multiplier_en,
